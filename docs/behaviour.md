...
| N42 | The slider **caps at 3**, deliberately. The old default of 5 was measured folding octave-plus-a-fifth errors and marking them confident; the control must not be able to return to it. | `#notes-fold-tol.max === '3'`. Past about 2 the tooltip warns that corrections start being trusted that cannot be justified. |
