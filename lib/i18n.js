...
(function (global) {
  ...
  const DICT = {
    'zh-TW': {
      ...
      'notes.zoomNotesChip': '音符',
      'notes.zoomNotesChipTip': '顯示／隱藏偵測到的音符；開啟時，其他波形會轉為灰色',
    ...
    'en': {
      ...
      'notes.zoomNotesChip': 'Notes',
      'notes.zoomNotesChipTip': 'Show/hide the detected notes; while on, other waveforms turn gray',
