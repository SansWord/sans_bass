...
export const DICT = {
  'zh-TW': {
    ...
    'notes.importStemMismatch': '這個檔案是給「{stem}」用的，但這首歌沒有載入這個音軌，所以沒有匯入任何內容。',
    'notes.importStemSkipped': '這個檔案也包含「{stems}」的編輯，但這首歌沒有載入這些音軌，已略過。',
    'notes.importUnknownStem': '不明音軌',
    'notes.listSecs': '每行秒數',
  ...
  'en': {
    ...
    'notes.importStemMismatch': 'This file was made for {stem}, which isn’t loaded in this song, so nothing was imported.',
    'notes.importStemSkipped': 'This file also has edits for {stems} — not loaded in this song, so skipped.',
    'notes.importUnknownStem': 'an unknown stem',
