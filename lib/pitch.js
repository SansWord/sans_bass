...
export function foldOctaves(notes, opts = {}) {
  ...
  for (let i = 0; i < out.length; i++) {
     ...
     * fold nothing it cannot justify: on ng_kipin it admits no odd-harmonic error at all,
     * at the cost of about half the true corrections, which become doubtful instead.
