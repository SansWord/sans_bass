 ...
 * cycles to compare. `window` is now a validated, measured value, not just the starting
 * guess from the arithmetic — see docs/transcription.md for the sweep: 512 is the noisiest
 * width tried, 768/1024/1536 land in a tight plateau, and 2048 buys nothing further while
 * more than doubling decode cost over 1024. */
