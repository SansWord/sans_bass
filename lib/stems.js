...
/** True for the other half of the two-ways-in dispatch (a single audio file vs a stems zip). */
function isZipFile(file) {
  return ZIP_RE.test(file.name);
}
...
export { STEMS, EXTRA_COLORS, AUDIO_RE, ZIP_RE, isZipFile, detectStem, assignStems, hasMixPlusStems };
