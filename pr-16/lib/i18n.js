...
(function (global) {
  ...
  const DICT = {
    'zh-TW': {
      ...
      'notes.foldTolTip': '修正後的音符必須落在前後音符的這個範圍內，才算可信。放寬會修正更多音符，但超過約 2 半音後，會開始把「高八度又高五度」的錯誤也當成可信的修正。',
    ...
    'en': {
      ...
      'notes.foldTolTip': 'How far a corrected note may land from its neighbours and still be trusted. Loosening it corrects more notes, but past about 2 semitones it starts trusting octave-plus-a-fifth errors too.',
