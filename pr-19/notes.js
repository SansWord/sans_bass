...
import { interpret, applyEdits, detectKey, notesToChroma, relativeKey } from './lib/pitch.js?v=1.16.0';
import { scheduleNotes } from './lib/sonify.js?v=1.16.0';
...
function analyse() {
  ...
  worker = new Worker('./notes.worker.js?v=1.16.0', { type: 'module' });
  worker.onmessage = (e) => {
    const m = e.data;
    worker.terminate();
    worker = null;
